...
class App extends React.Component {
    ...
    render() {
      return (
        <div>
        <text>{this.state.strategies[Math.floor(Math.random() * this.state.strategies.length)]}</text>
        </div>
      )
    }
  }
